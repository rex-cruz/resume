            ...
            <div class="skills">
                ...
                <?php foreach ($data['skills'] as $item): ?>
                    ...
                    <?php foreach ($item['technologies'] as $technology): ?>
                        <div class="languages">
                            <p><span><?php echo $technology['name']; ?></span><span
                                        style="float: right"><?php echo $technology['number_of_years']; ?><?php echo ($technology['number_of_years'] > 1) ? 'years' : 'year'; ?></span>
                            </p>
                        </div>
                    <?php endforeach; ?>
                <?php endforeach; ?>
        ...
        <div class="details">
            <ul class="work">
                ...
                <?php if ($project['startDate']): ?>
                    <li class="col-lg-12"><p
                                class="date"><?php echo $project['startDate']; ?><?php echo ($project['endDate']) ? ' - ' . $project['endDate'] : ''; ?><?php echo $project['months']; ?></p>
                    </li>
                <?php endif; ?>
